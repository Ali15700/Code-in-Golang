...
func registerHandler(w http.ResponseWriter, r *http.Request) {
	...
	tpl.ExecuteTemplate(w, "registerform.html", nil)
}
...
func registerAuthHandler(w http.ResponseWriter, r *http.Request) {
	...
	*/
	...
	if err != sql.ErrNoRows {
		...
		tpl.ExecuteTemplate(w, "registerform.html", "username already taken")
		return
	}
	...
	if err != nil {
		...
		tpl.ExecuteTemplate(w, "registerform.html", "there was a problem registering account")
		return
	}
